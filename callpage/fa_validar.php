		...
		<?php
				...
				while($fi=$rs->fetchArray(SQLITE3_ASSOC)){
					...
					if($ind_situ=='03' || $ind_situ=='04' || $ind_situ=='11' || $ind_situ=='12'){
						...
						if(file_exists($origen.".aca")){
							rename($origen.".aca",$destino.".aca");
							//unlink($origen.".aca");
							$men.=" aca";
						}
						...
						if(file_exists($origen.".pag")){
							rename($origen.".pag",$destino.".pag");
							//unlink($origen.".pag");
							$men.=" pag";
						}
						if(file_exists($origen.".dpa")){
							rename($origen.".dpa",$destino.".dpa");
							//unlink($origen.".dpa");
							$men.=" dpa";
						}
					}
