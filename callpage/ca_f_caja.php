...
?>
				...
				<div class="form-group dfpag">
				    <label for="ncuo" class="col-sm-2 control-label">CUOTAS</label>
				    <div class="col-sm-3">
						<input type="number" class="form-control" name="ncuo" id="ncuo" value="1">
				    </div>
					<label for="per" class="col-sm-4 control-label">PERIODO (DÍAS)</label>
				    <div class="col-sm-3">
						<input type="number" class="form-control" name="per" id="per" value="15">
				    </div>
				</div>
				<div class="form-group">
					<label for="ngui" class="col-sm-2 control-label gui"># GUÍA R.</label>
				    <div class="col-sm-4 gui">
